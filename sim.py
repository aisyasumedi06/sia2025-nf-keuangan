...
/* ====== HAPUS SEMUA HEADER ATAS ====== */
[data-testid="stHeader"] {
    display: none !important;
}

/* ====== HAPUS DEKORASI STRIP ATAS ====== */
[data-testid="stDecoration"] {
    display: none !important;
    height: 0 !important;
}

/* ====== HAPUS GARIS / SHADOW DEFAULT ====== */
...
/* ====== HAPUS TOP MARGIN YANG BIKIN GARIS ====== */
.block-container {
    padding-top: 0 !important;
    margin-top: 0 !important;
}

/* ====== HAPUS BACKGROUND / LINE DI MAIN WRAPPER ====== */
...
/* ====== HAPUS BADGES YANG MUNCUL DI KANAN BAWAH ====== */
[data-testid="viewerBadge"] {
    display: none !important;
}

/* ====== HAPUS TOOLBAR STREAMLIT (kadang bikin garis) ====== */
...
div[role="radiogroup"] > label:hover {
    background-color: #fcb9c8 !important;
}
...
<style>
 ...
 /* ================================
    FORM CONTAINER TAMBAH TRANSAKSI
   ================================ */
div[data-testid="stExpander"], 
div[data-testid="stForm"], 
section[data-testid="stSidebar"] ~ div div[data-testid="stVerticalBlock"] > div {
    background-color: #fd9cb8 !important;  /* pink */
    border-radius: 12px !important;
    padding: 18px !important;
    border: 1px solid #f4c7dd !important;
}

 /* ================================
    WARNA INPUT DI DALAM FORM
   ================================ */
div[data-baseweb="input"], 
input, 
textarea, 
div[data-baseweb="select"] {
    background-color: #fdeef5 !important; /* PINK */
    color: #333 !important;
...
label, .st-emotion-cache-1kyxreq {
    color: #4a001f !important;  /* Pink gelap */
...
# Halaman Laporan Perubahan Modal
    ...
    # Panggil update_buku_besar untuk mendapatkan saldo terbaru
    update_buku_besar() 
...
# Halaman Laporan Posisi Keuangan
    ...
    update_buku_besar() # Pastikan buku besar sudah terupdate
    df_buku_besar = st.session_state.get("df_buku_besar", pd.DataFrame())
...
# Halaman Jurnal Penutup
    ...
    # ... (Logika Jurnal Penutup tetap sama) ...
