...
/* ================ HAPUS TOOLBAR, BADGE, ETC ================ */
[data-testid="stToolbar"],
[data-testid="stToolbar"]:before,
[data-testid="viewerBadge"],
[data-testid="viewerBadge"]:before {
    display: none !important;
}

/* ================ MAIN WRAPPER CLEAN ================ */
main, section, section.main, section.main > div {
    background: #fffef4 !important;
}

/* ================ BLOK KONTEN STREAMLIT ================ */
.block-container {
    margin: 0 !important;
    padding: 0 !important;
...
/* ================ HAPUS GARIS DARI ELEMENT YANG KAMU BUAT SENDIRI ================ */
